const styles = {
  ...
  weapon: 'w-[260px] h-[120px] xl:flex-row object-contain cursor-pointer hover:bg-violet-400 w-full rounded-lg py-2.5 text-sm font-medium leading-5 text-blue-700',

  // glassmorphism
  glassEffect: 'bg-white backdrop-filter backdrop-blur-lg bg-opacity-10',

  // hoc page
  hocContainer: 'min-h-screen flex xl:flex-row flex-col relative justify-between',
  ...
  hocBodyWrapper: 'flex-1 flex justify-start flex-col xl:mt-0 my-16',

  // join game page
  //joinHeadText: 'font-rajdhani font-semibold text-2xl text-white mb-3',
  joinContainer: 'flex flex-col gap-3 mt-3 mb-5',
  joinGameTitle: 'font-rajdhani font-normal text-xl text-white',
 ...
 */
  ...
  btn: 'px-4 py-2 rounded-lg enabled:bg-siteViolet disabled:bg-gray-200 enabled:hover:bg-violet-800 w-fit text-white font-rajdhani font-bold',
  ...
  gameLoadPlayersBox: 'flex justify-evenly items-center mt-18',
